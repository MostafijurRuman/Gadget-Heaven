...
export default function Dashboard() {
  ...
  const Products =useLoaderData();
   ...
   const [cartProduct, setCartProduct] = useState([]);
    ...
    useEffect(() => {
      const filteredProducts = Products.filter(product => cart.includes(product.product_id));
    ...
    <div>
        ...
        <div className="flex justify-between items-center mt-12">
          ...
          <div className="flex gap-6">
              <h1 className="text-[24px] font-bold">Total cost: 999 </h1>
              <button className="btn text-[18px] font-semibold text-[#9538E2] bg-white border-[#9538E2] rounded-4xl hover:bg-[#9538E2] hover:text-white mr-4">
                Sort by Price <LuArrowUpDown /></button>
